"""Run Berkeley milling inner-validation downstream checks.

These runs are development diagnostics only. They use the frozen inner-train /
inner-val split and write checkpointed CSVs so interrupted runs resume without
duplicating rows.
"""
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", default="breeze/results/milling_berkeley_inner_attack_2026-07-08/downstream_current_pools")
    parser.add_argument("--dataset-name", default="Berkeley_milling")
    parser.add_argument("--split-name", default="inner_val_current_pool_diagnostic")
    ...
    parser.add_argument("--val-npz", default="proc/milling_berkeley_inner_val.npz")
